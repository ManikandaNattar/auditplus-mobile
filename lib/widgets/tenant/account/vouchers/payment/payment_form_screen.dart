...
class _PaymentFormScreenState extends State<PaymentFormScreen> {
  ...
  List adjustments = [];
  Map _voucherPaymentDetail = {};
  Map _paymentVoucherData = {};
  Map _toAccountData = {};
  Map _byAccountData = {};
  Map arguments = {};
  ...
  String _paymentVoucherId = '';
  String _paymentVoucherName = '';
  String toAccountId = '';
  String byAccountId = '';
  ...
  void didChangeDependencies() {
    ...
    if (arguments != null && arguments['id'] != null) {
      _voucherPaymentDetail = arguments['detail'];
      _paymentVoucherId = arguments['id'];
      _paymentVoucherName = arguments['displayName'];
      _getFormData();
    } else {
  ...
  void _getFormData() {
    List _paymentVoucherTransactions = _voucherPaymentDetail['trns'];
    _toAccountDetail = _paymentVoucherTransactions
        ...
        : _paymentVoucherTransactions
            .where((element) => element['credit'] == 0)
            .first;
    _byAccountDetail = _paymentVoucherTransactions
    ...
    _dateController.text = _dateController.text.isEmpty
        ? _voucherPaymentDetail['date'].toString().isEmpty
            ? constants.defaultDate.format(DateTime.now())
            : constants.defaultDate.format(
                DateTime.parse(
                  _voucherPaymentDetail['date'],
                ),
              )
    ...
    _refNoController.text = _voucherPaymentDetail['refNo'];
    _amountController.text = double.parse(
      _toAccountDetail['debit'].toString(),
    ).toStringAsFixed(2);
    _instNoController.text = _byAccountDetail['instNo'];
    _descriptionController.text = _voucherPaymentDetail['description'];
    if (_voucherPaymentDetail['cashRegisterEnabled'] != null &&
        _voucherPaymentDetail['cashRegisterEnabled'] == true) {
  ...
  Future<void> _onSubmit() async {
    if (_formKey.currentState.validate()) {
      ...
      try {
        if (_paymentVoucherId.isEmpty) {
          await _voucherProvider.createVoucher(_paymentVoucherData);
          utils.showSuccessSnackbar(
              _screenContext, 'Payment Voucher Created Successfully');
        } else {
          ...
          utils.showSuccessSnackbar(
              _screenContext, 'Payment Voucher updated Successfully');
        }
  ...
  Widget _accountPaymentVoucherInfo() {
    return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              DatePickerFormField(
                ...
                onSaved: (value) {
                  _paymentVoucherData['date'] = constants.isoDateFormat
              ...
              TextFormField(
                ...
                onSaved: (val) {
                  if (val.isNotEmpty) {
                    _paymentVoucherData.addAll({'refNo': val});
                  }
                },
              ),
              SizedBox(
  ...
  Widget _accountPaymentFormTransactionInfo() {
    return Container(
      width: double.infinity,
      child: Card(
        elevation: 10.0,
          ...
          child: Column(
            ...
            children: [
              ...
              AutocompleteFormField(
                ...
                validator: (val) {
                  if (toAccountId.isEmpty && val == null) {
                    return 'Payment Account should not be empty';
                  }
                  return null;
                },
                ...
                suffixIconWidget: Visibility(
                  child: IconButton(
                    ...
                    onPressed: () => Navigator.of(context).pushNamed(
                      ...
                      arguments: {
                        'routeForm': 'PaymentToAccount',
                        'id': _paymentVoucherId,
                        'displayName': _paymentVoucherName,
                        'detail': _paymentVoucherData,
              ...
              Visibility(
                ...
                visible: _voucherPaymentDetail['cashRegisterEnabled'] != null &&
                        _voucherPaymentDetail['cashRegisterEnabled'] == true ||
              ...
              TextFormField(
                ...
                onSaved: (val) {
                  if (val.isNotEmpty) {
                    _paymentVoucherData.addAll({'description': val});
                  }
                },
                maxLines: null,
              ),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            _paymentVoucherName.isEmpty ? 'Add Payment' : _paymentVoucherName,
          ),
          actions: [
            TextButton(
              onPressed: () {
              ...
              child: Container(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _accountPaymentVoucherInfo(),
                      _accountPaymentFormTransactionInfo(),
                    ],
                  ),
                ),
              ),
