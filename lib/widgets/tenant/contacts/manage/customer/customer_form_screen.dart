...
class _CustomerFormScreenState extends State<CustomerFormScreen> {
  ...
  Map<String, dynamic> _getCustomer() {
    ...
    _customerGroupTextEditingController.text =
        _customerDetail.keys.contains('customerGroup')
            ? _customerDetail['customerGroup']['name']
            : '';
    ...
    _stateTextEditingController.text = _customerDetail['addressInfo']['state']
            .toString()
            .replaceAll('null', '')
            .isEmpty
        ? ''
        : _customerDetail['addressInfo']['state']['name'];
    _countryTextEditingController.text = _customerDetail['addressInfo']
                ['country']
            .toString()
            .replaceAll('null', '')
            .isEmpty
              ...
              child: Column(
                children: [
                  ...
                  AutocompleteFormField(
                    ...
                    onSaved: (val) {
                      _customerData.addAll(
                          {'customerGroup': val == null ? null : val['id']});
                    },
