...
class ContactsOpeningForm extends StatefulWidget {
  @override
  _ContactsOpeningFormState createState() => _ContactsOpeningFormState();
}

class _ContactsOpeningFormState extends State<ContactsOpeningForm> {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              _formData['openingCustomer'].toUpperCase(),
