...
import '../../../../../providers/inventory/doctor_provider.dart';
      ...
      data.map(
        (elm) {
          return {
            'id': elm['id'],
            'title': elm['name'],
            'subtitle': elm['licenseNo'] == null ? '' : elm['licenseNo'],
          };
        },
      ).toList(),
    );
    ...
    return WillPopScope(
      child: Scaffold(
        ...
        body: GeneralListView(
          ...
          routeName: '/inventory/sale/doctor/detail',
          list: _doctorList,
        ...
        floatingActionButton: Visibility(
          child: FloatingActionButton(
            ...
            tooltip: 'Add Doctor',
            onPressed: () =>
                Navigator.of(context).pushNamed('/inventory/sale/doctor/form'),
          ),
