...
class SalePurchaseFilterForm extends StatefulWidget {
  @override
  _SalePurchaseFilterFormState createState() => _SalePurchaseFilterFormState();
}

class _SalePurchaseFilterFormState extends State<SalePurchaseFilterForm> {
