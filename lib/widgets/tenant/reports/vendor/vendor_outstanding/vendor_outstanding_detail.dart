...
class VendorOutstandingDetail extends StatelessWidget {
  final Map formData;
  final List list;
  final Function onScrollEnd;

  VendorOutstandingDetail({
    @required this.formData,
    @required this.list,
    @required this.onScrollEnd,
  });

  Widget _showVendorOutstandingDetail(BuildContext context) {
    return Expanded(
      child: Container(
        child: list.isEmpty
            ? Center(
  ...
  Widget _showVendorOutstandingHeader(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 8.0,
        vertical: 0.0,
  ...
  Widget build(BuildContext context) {
    return formData['isLoading'] == true
        ...
        : Column(
            children: [
              _showVendorOutstandingHeader(context),
              Divider(
                thickness: 1.0,
              ),
              _showVendorOutstandingDetail(context),
