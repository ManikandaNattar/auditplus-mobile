...
class SalesByInchargeFormScreen extends StatefulWidget {
  @override
  _SalesByInchargeFormScreenState createState() =>
      _SalesByInchargeFormScreenState();
}

class _SalesByInchargeFormScreenState extends State<SalesByInchargeFormScreen> {
  ...
  Widget _salesByInchargeFormDateContainer() {
    return Container(
  ...
  Widget _salesByInchargeFormBranchContainer() {
    return Container(
      width: double.infinity,
      child: Card(
        elevation: 10.0,
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                _salesByInchargeFormDateContainer(),
                _salesByInchargeFormBranchContainer(),
              ],
            ),
          ),
        ),
