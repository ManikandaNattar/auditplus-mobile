...
class SaleRegisterFormScreen extends StatefulWidget {
  @override
  _SaleRegisterFormScreenState createState() => _SaleRegisterFormScreenState();
}

class _SaleRegisterFormScreenState extends State<SaleRegisterFormScreen> {
  ...
  Widget _saleRegisterFormDateContainer() {
    return Container(
  ...
  Widget _saleRegisterFormBranchContainer() {
    return Container(
      width: double.infinity,
      child: Card(
        elevation: 10.0,
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                _saleRegisterFormDateContainer(),
                _saleRegisterFormBranchContainer(),
              ],
            ),
          ),
        ),
