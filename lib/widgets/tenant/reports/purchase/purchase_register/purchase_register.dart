...
import 'package:auditplusmobile/widgets/tenant/reports/purchase/purchase_register/purchase_register_footer.dart';
...
class PurchaseRegister extends StatelessWidget {
  ...
  Widget _showPurchaseRegister(BuildContext context) {
    return Expanded(
      child: Container(
        child: list.isEmpty
            ? Center(
  ...
  Widget _showPurchaseRegisterHeader(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 8.0,
        vertical: 0.0,
    ...
    return formData['isLoading'] == true
        ...
        : Column(
            ...
            children: [
              ...
              _showPurchaseRegisterHeader(context),
              Divider(
                thickness: 1.0,
              ),
              _showPurchaseRegister(context),
              PurchaseRegisterFooter(
                formData: {
