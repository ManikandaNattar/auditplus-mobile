...
class CustomerOutstandingSummary extends StatelessWidget {
  final Map formData;
  final List list;
  ...
  Widget _showCustomerOutstandingSummary(BuildContext context) {
    return Expanded(
      child: Container(
        child: list.isEmpty
            ? Center(
    ...
    return formData['isLoading'] == true
        ...
        : Column(
            children: [
              ...
              _showCustomerOutstandingSummary(context),
