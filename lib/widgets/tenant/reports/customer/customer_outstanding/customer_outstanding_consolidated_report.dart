...
import 'package:auditplusmobile/widgets/tenant/reports/customer/customer_outstanding/customer_outstanding_footer.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class CustomerOutstandingConsolidatedReport extends StatelessWidget {
  final ScrollController _scrollController = ScrollController();
  final Map formData;
  final List list;
  final Function onScrollEnd;

  CustomerOutstandingConsolidatedReport({
