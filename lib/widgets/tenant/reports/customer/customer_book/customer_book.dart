...
import 'package:auditplusmobile/widgets/tenant/reports/customer/customer_book/customer_book_footer.dart';
...
class CustomerBook extends StatelessWidget {
  ...
  Widget _showCustomerBook(BuildContext context) {
    return Expanded(
      child: Container(
        child: list.isEmpty
            ? Center(
  ...
  Widget _showCustomerBookHeader(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 8.0,
        vertical: 0.0,
    ...
    return formData['isLoading'] == true
        ...
        : Column(
            ...
            children: [
              ...
              _showCustomerBookHeader(context),
              Divider(
                thickness: 1.0,
              ),
              _showCustomerBook(context),
              CustomerBookFooter(
                formData: {
