...
class CustomerBookFormScreen extends StatefulWidget {
  @override
  _CustomerBookFormScreenState createState() => _CustomerBookFormScreenState();
}

class _CustomerBookFormScreenState extends State<CustomerBookFormScreen> {
  ...
  void _getFormData() {
    ...
    _customerTextEditingController.text = arguments['customer'] == ''
        ? _customerTextEditingController.text
        : arguments['customer']['name'];
    _customerTextEditingController.selection = TextSelection.fromPosition(
      TextPosition(
        offset: _customerTextEditingController.text.length,
      ),
    );
  ...
  Widget _customerBookFormDateContainer() {
    return Container(
  ...
  Widget _customerBookFormCustomerContainer() {
    return Container(
      width: double.infinity,
      child: Card(
        elevation: 10.0,
          ...
          child: Column(
            ...
            children: [
              ...
              AutocompleteFormField(
                initialValue:
                    utils.cast<Map<String, dynamic>>(arguments['customer']),
                autoFocus: false,
                ...
                autocompleteCallback: (pattern) async {
                  return await _customerProvider.customerAutoComplete(
                    searchText: pattern,
                  );
                },
                validator: (value) {
  ...
  Widget _customerBookFormBranchContainer() {
    return Container(
      width: double.infinity,
      child: Card(
        elevation: 10.0,
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                _customerBookFormDateContainer(),
                _customerBookFormCustomerContainer(),
                _customerBookFormBranchContainer(),
              ],
            ),
          ),
        ),
