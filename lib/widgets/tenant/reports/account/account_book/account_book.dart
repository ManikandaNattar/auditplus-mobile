...
import 'package:auditplusmobile/widgets/tenant/reports/account/account_book/account_book_footer.dart';
...
class AccountBook extends StatelessWidget {
  ...
  Widget _showAccountBook(BuildContext context) {
    return Expanded(
      child: Container(
        child: list.isEmpty
            ? Center(
  ...
  Widget _showAccountBookHeader(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 8.0,
        vertical: 0.0,
    ...
    return formData['isLoading'] == true
        ...
        : Column(
            ...
            children: [
              ...
              _showAccountBookHeader(context),
              Divider(
                thickness: 1.0,
              ),
              _showAccountBook(context),
              AccountBookFooter(
                formData: {
